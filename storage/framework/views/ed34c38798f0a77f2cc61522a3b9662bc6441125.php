...
<?php $__env->startSection('content'); ?>
    <nav>
        ...
        <div class="menuli">
            <li class="active"><a href="/annonces">Dashboard</a></li>
            <li ><a href="/yourannonce">Profile</a></li>
        </div>
        <div class="burmenu">
    ...
    <div class="container">
      ...
      <section>
        <div class="btnsec">
        <button><a href="/annonces">Les Annonces</a></button>
        <button ><a href="/orders">Les Ordres</a></button>
        </div>
        <div class="addP">
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\capcar\resources\views/home.blade.php ENDPATH**/ ?>